...
import { useActiveSectionContext, useIsSmall } from '@/utils/hooks';
...
export default function Projects() {
    ...
    const storeAndroidComponent = (param: string) => {
        return (
            <Link href={param} target='_blank' className="w-full mb-3 md:mb-0 sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
    ...
    const storeIOSComponent = (param: string) => {
        return (
            <Link href={param} target='_blank' className="w-full sm:w-auto bg-gray-800 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 text-white rounded-lg inline-flex items-center justify-center px-1 py-2.5 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
        ...
        <motion.div
            ...
            <div className="flex-1 m-2 md:mb-1 mb-3 overflow-hidden rounded-lg shadow-lg transition hover:shadow-2xl dark:shadow-gray-700/25">
                ...
                <div className="bg-white p-4 sm:p-6">
                    <Link href={storeAndroid} target='_blank'>
                        <h3 className="mt-0.5 text-lg text-gray-900 dark:border-solid dark:border-white dark:border-4 dark:text-white">
                            {title}
                        </h3>
                    </Link>
